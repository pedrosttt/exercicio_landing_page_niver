...
var dataDoEvento = new Date("Oct 20, 2023, 19:00:00");
...
var contaAsHoras = setInterval(function () {
  ...
  var horasEmMs = 1000 * 60 * 60;
  var minutosEmMs = 1000 * 60;
  var diasAteOEvento = Math.floor(distanciaAteOEvento / diaEmMs);
  var horasAteOEvento = Math.floor(distanciaAteOEvento % diaEmMs / horasEmMs);
  var minutosAteOEvento = Math.floor(distanciaAteOEvento % horasEmMs / minutosEmMs);
  var segundosAteOEvento = Math.floor(distanciaAteOEvento % minutosEmMs / 1000);

  // Atualiza o contador na página
  document.getElementById('contador').innerHTML = "".concat(diasAteOEvento, "d ").concat(horasAteOEvento, "h ").concat(minutosAteOEvento, "m ").concat(segundosAteOEvento, "s");
